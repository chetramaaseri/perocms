        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown">
                ...
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                    <img src="<?=$base_url?>/assets/images/logo/icon.png" class="avatar img-fluid rounded me-1" alt="<?=$this->session->full_name?>" /> <span
                        class="text-dark"><?=$this->session->full_name?></span>
                </a>
